...
class AQOSPQuizQuestionsPage extends StatefulWidget {
  ...
  @override
  _AQOSPQuizQuestionsPageState createState() => _AQOSPQuizQuestionsPageState();
}

class _AQOSPQuizQuestionsPageState extends State<AQOSPQuizQuestionsPage> {
  ...
  void initState() {
    ...
    // Ensure quizData['questions'] is not null
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => FEResultPage(
                ...
                email: widget.email, // Pass email to the result page
              ),
            ),
          );
        } else {
  ...
  Widget _buildQuizQuestions() {
    String quizId = widget.quizData['quiz_id'] ?? ''; // Get quiz_id safely
            ...
            return Column(
              ...
              children: [
                ...
                if (widget.show_questions_category)
                  Padding(
                    padding:
                        EdgeInsets.all(8.0), // Add padding of 8.0 to all sides
                    child: Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                                        ...
                                        Padding(
                                          ...
                                          child: Image.network(
                                            answer['answer_image']
                                                    .startsWith('http')
                                                ? answer['answer_image']
                                                : 'https://dental-key-738b90a4d87a.herokuapp.com${answer['answer_image']}',
                                            width: double.infinity,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
