...
class FEResultPage extends StatefulWidget {
  ...
  @override
  _FEResultPageState createState() =>
      _FEResultPageState(accessToken: accessToken);
}

class _FEResultPageState extends State<FEResultPage> {
  final String accessToken;

  _FEResultPageState({required this.accessToken});
  ...
  String formatUrl(String url) {
    return url.startsWith('http')
        ? url
        : 'https://dental-key-738b90a4d87a.herokuapp.com$url';
  }
