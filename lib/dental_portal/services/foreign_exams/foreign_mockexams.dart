...
import 'package:dental_key/dental_portal/services/foreign_exams/foreignexams_cart_page.dart';
...
class ForeignMockExam extends StatefulWidget {
  ...
  @override
  _ForeignMockExamState createState() =>
      _ForeignMockExamState(accessToken: accessToken);
}

class _ForeignMockExamState extends State<ForeignMockExam> {
  List<dynamic> quizzes = [];
  final String accessToken;
  late String quizCategoryUUID;
  bool isLoading = false;

  _ForeignMockExamState({required this.accessToken});

  final FECart fecart = FECart(); // Initialize FECart instance
  ...
  Future<void> fetchQuizzes() async {
    quizCategoryUUID = "6c1d0439-39b0-4fe9-aaea-377a79c4ccaa";
    String url =
  ...
  void addToCart(String quizUUID, String title, String description,
    ...
    setState(() {
      fecart.addToCart(quizUUID, title, description, imageUrl, price);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Embark on a global dental odyssey with our immersive mock exams tailored for international certification. Dive into the dynamic world of dentistry as you navigate challenging scenarios, sharpen your skills, and unlock your potential for success.',
                        style: TextStyle(
                          fontSize: 16,
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ForeignExamsCartPage(
                  fecart: fecart,
                  accessToken: accessToken,
