...
import 'package:dental_key/dental_portal/services/foreign_exams/all_questions_on_single.dart';
import 'package:dental_key/dental_portal/services/foreign_exams/one_q_per_page_set.dart';
...
class Quiz {
  ...
  final bool schedule_quiz;
  final String message_if_unpublished;
  ...
  factory Quiz.fromJson(Map<String, dynamic> json) {
    return Quiz(
      ...
      remainingAttempt: json['remaining_attempts'],
      displayAllQuestionsOnOnePage:
          json['display_all_questions_on_one_page'] ?? false,
      total_questions: json['total_questions'] ?? 0,
      show_questions_counter: json['show_questions_counter'] ?? false,
