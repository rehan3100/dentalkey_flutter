...
import 'package:dental_key/dental_portal/services/ug_exams_tests/04_UG_BankTransferform.dart';
import 'package:dental_key/dental_portal/services/ug_exams_tests/04_UG_dentalpaymentgateway.dart';
...
class UGTestsOrders extends StatefulWidget {
  final String accessToken;

  const UGTestsOrders({Key? key, required this.accessToken}) : super(key: key);

  @override
  _UGTestsOrdersState createState() =>
      _UGTestsOrdersState(accessToken: accessToken);
}

class _UGTestsOrdersState extends State<UGTestsOrders> {
  ...
  Future<void> fetchRequests() async {
    final String apiUrl =
        'https://dental-key-738b90a4d87a.herokuapp.com/quizzer/user_requests/?quiz_category=9c3ea843-7f93-4315-b44f-eae56e93b1af';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Sort requests by order date in ascending order (oldest first)
        fetchedRequests.sort((a, b) => DateTime.parse(a['request_date'])
  ...
  final String accessToken;
  _UGTestsOrdersState({required this.accessToken});
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('My Undergraduate Orders'),
        ),
                                            ...
                                            ListTile(
                                              title: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                      'Total Price: GBP ${requests[index]['request_total_price']}'),
                                                  Text(
