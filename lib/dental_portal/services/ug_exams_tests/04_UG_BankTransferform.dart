...
class UGBankTransferForm extends StatefulWidget {
  final String userId;
  ...
  @override
  _UGBankTransferFormState createState() =>
      _UGBankTransferFormState(accessToken: accessToken);
}

class _UGBankTransferFormState extends State<UGBankTransferForm> {
  File? _image;
  ...
  final String accessToken;
  _UGBankTransferFormState({required this.accessToken});
      ...
      if (response.statusCode == 201) {
        ...
        if (updateOrderResponse.statusCode == 200) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => UGTestsOrders(accessToken: accessToken)),
          );
        } else {
          print(
