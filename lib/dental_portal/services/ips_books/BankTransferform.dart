...
class BankTransferForm extends StatefulWidget {
  ...
  @override
  _BankTransferFormState createState() =>
      _BankTransferFormState(accessToken: accessToken);
}
...
class _BankTransferFormState extends State<BankTransferForm> {
  ...
  final String accessToken;
  _BankTransferFormState({required this.accessToken});
  ...
  Future<void> fetchBankTransferOptions() async {
    try {
      final Uri apiUrl = Uri.parse(
          'https://dental-key-738b90a4d87a.herokuapp.com/ips/bank_transfer_options/');
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        'Order Price: GBP ${widget.orderprice}',
                        style: TextStyle(
                            fontSize: 14,
  ...
  Future<void> submitForm() async {
    final Uri apiUrl = Uri.parse(
        'https://dental-key-738b90a4d87a.herokuapp.com/ips/bank_payment/');
    ...
    request.fields['order'] = widget.orderId;
    request.fields['order_total_price'] = widget.orderprice;
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        final updateOrderStatusUrl = Uri.parse(
            'https://dental-key-738b90a4d87a.herokuapp.com/ips/api/v1/orders/${widget.orderId}/update_status/');
        final updateOrderResponse = await http.post(
          ...
          body: json.encode({'order_status': 'PD'}),
        );
        ...
        if (updateOrderResponse.statusCode == 200) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => DentalMyOrders(accessToken: accessToken)),
          );
        } else {
          print(
